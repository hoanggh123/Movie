...
const filterVideos = function (videoList) {
  return videoList.filter(({ type, site }) =>(type === 
    "Trailer" || type === "Teaser") && site === "YouTube");
    
};
fetchDataFromServer(
  `https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&language=en-US&append_to_response=casts,videos,mages,releases`,
  function (movie) {
    const {
      backdrop_path,
      poster_path,
    ...
    movieDetail.innerHTML =`
      <div
        ...
        style="background-image: url('${imgBaseURL}${"w1280" ||
